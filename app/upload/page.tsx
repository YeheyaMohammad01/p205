        ...
        <section aria-labelledby="file-types-heading">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <CardDescription>Bank statements, receipts, and invoices in PDF format</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>Transaction exports from your bank or financial apps</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>Photos of receipts and paper documents (JPG, PNG)</CardDescription>
              </CardContent>
            </Card>
          </div>
        </section>
